...
import com.example.backendcargoflow.controller.vehicle.models.VehicleDashboardSummaryResponseDto;
...
public class VehicleController implements VehiclesApi {
    ...
    public GenericApplicationResponseDto addNewVehicle(
            @RequestBody AddNewVehicleRequestDto addNewVehicleRequestDto) {
    ...
    public VehicleDashboardSummaryResponseDto getVehicleDashboardSummary() {
        log.info(LogMessage.GET_VEHICLE_DASHBOARD_SUMMARY);
        return vehicleService.getVehicleDashboardSummary();
    }
}
